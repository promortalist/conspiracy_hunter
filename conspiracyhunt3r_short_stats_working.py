...
for path in paths:
     try:
        ...
        print(title[0][0])
        listk = list(ksiazka(path))
        print(listk)
        for shamingword in listk:
           metametaice.append(shamingword) 
        print("-------------------------------------------------------")
     except:
        pass
freqword = defaultdict(list)
for word, freq in Counter(metametaice).items():
